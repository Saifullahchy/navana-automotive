// Home page — hero, search, categories, featured cars, why, showrooms, CTA

const HERO_IMAGES = {
  city: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=2200&auto=format&fit=crop&q=80",
  studio: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=2200&auto=format&fit=crop&q=80",
  road: "https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=2200&auto=format&fit=crop&q=80"
};
...
const HomePage = ({ setPage, t, setTweak, openCar }) => {
  ...
  return (
    <React.Fragment>
      ...
      <section className="hero-cine">
        ...
        <div className="inner">
          ...
          <div className="center">
            <div className="eye-ribbon" style={{ margin: "1px" }}>IGNITE&nbsp;LEGACY · NAVANA CERTIFIED</div>
            <h1 className="serif">
          ...
          <div className="ticker" style={{ borderWidth: "0px" }}>
      ...
      <div className="hero-search-wrap" style={{ margin: "-100px 58.1094px 0px" }}>
        <div className="hero-search-card" style={{ margin: "-21.8945px 0px 0px" }}>
      ...
      {/* Brand strip */}
      <div className="brand-strip" style={{ margin: "47.4141px 0px 0px", borderStyle: "none", borderColor: "rgb(247, 245, 240)" }}>
